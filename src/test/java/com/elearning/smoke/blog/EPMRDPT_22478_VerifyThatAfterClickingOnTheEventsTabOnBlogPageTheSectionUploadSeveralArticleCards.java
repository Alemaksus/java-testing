...
@Test(description = "EPMRDPT_22478_VerifyThatAfterClickingOnTheEventsTabOnBlogPageTheSectionUploadSeveralArticleCards",
    groups = {"full", "general", "smoke"})
public class EPMRDPT_22478_VerifyThatAfterClickingOnTheEventsTabOnBlogPageTheSectionUploadSeveralArticleCards {
  ...
  public void checkAfterClickNewsTabArticlesByNewsTypeAreUploaded() {
    assertTrue(blogScreen
            ...
            .isAllCardsHasRequiredCategory(LocaleProperties
                .getValueOf(LocalePropertyConst.BLOG_EVENTS_TAB)),
        "After clicking on 'EVENTS' tab article cards aren't have 'Events' category!");
  }
