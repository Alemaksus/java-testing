...
@Test(description = "EPMRDPT_30507_VerifyThatPopUpForExpiredOnlineTaskIsDisplayedCorrectlyForDepartmentAffiliateClass",
    groups = {"full", "regression", "student"})
public class EPMRDPT_30507_VerifyPopUpForExpiredOnlineTaskForDepartmentAffiliateClass {
