...
@Test(description = "EPMRDPT_13273_VerifyRejectedOnlineTaskPopUpContentOfEpamTrainingGroup",
    groups = {"full", "regression", "student"})
public class EPMRDPT_13273_VerifyRejectedOnlineTaskPopUpContentOfEpamTrainingGroup {
  ...
  public void checkStudentInfoInAllCommentsSection() {
    ...
    softAssert
        .assertTrue(
            datePattern.matcher(tasksPopUpScreenOnLearningPageScreen
