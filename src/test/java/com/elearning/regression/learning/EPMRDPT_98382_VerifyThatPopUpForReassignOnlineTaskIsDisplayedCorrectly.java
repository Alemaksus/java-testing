...
@Test(description = "EPMRDPT_98382_VerifyThatPopUpForReassignOnlineTaskIsDisplayedCorrectly",
    groups = {"full", "regression", "student"})
public class EPMRDPT_98382_VerifyThatPopUpForReassignOnlineTaskIsDisplayedCorrectly {
