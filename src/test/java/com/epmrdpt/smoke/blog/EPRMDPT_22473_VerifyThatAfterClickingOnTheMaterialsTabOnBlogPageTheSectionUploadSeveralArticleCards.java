...
@Test(description = "EPRMDPT_22473_VerifyThatAfterClickingOnTheMaterialsTabOnBlogPageTheSectionUploadSeveralArticleCards",
    groups = {"full", "general", "smoke"})
public class EPRMDPT_22473_VerifyThatAfterClickingOnTheMaterialsTabOnBlogPageTheSectionUploadSeveralArticleCards {
  ...
  public void checkAfterClickNewsTabArticlesByNewsTypeAreUploaded() {
    assertTrue(blogScreen
            ...
            .clickTabByCategoryName(LocaleProperties.getValueOf(LocalePropertyConst.BLOG_MATERIALS_TAB))
            .isAllCardsHasRequiredCategory(LocaleProperties
                .getValueOf(LocalePropertyConst.BLOG_MATERIALS_TAB)),
        "After clicking on 'MATERIALS' tab article cards aren't have 'Materials' category!");
  }
}
