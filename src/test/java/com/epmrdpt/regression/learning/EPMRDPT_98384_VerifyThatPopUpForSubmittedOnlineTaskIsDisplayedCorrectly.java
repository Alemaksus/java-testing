...
@Test(description = "EPMRDPT_98384_VerifyThatPopUpForSubmittedOnlineTaskIsDisplayedCorrectly",
    groups = {"full", "regression", "student"})
public class EPMRDPT_98384_VerifyThatPopUpForSubmittedOnlineTaskIsDisplayedCorrectly {
  ...
  private final String showMoreText = getValueOf(ONLINE_POPUP_USER_COMMENT_SHOW_MORE);
  private final String showLessText = getValueOf(ONLINE_POPUP_USER_COMMENT_SHOW_LESS);
  ...
  private final String submissionTaskRegex =
      String.format(getValueOf(ONLINE_POPUP_TASK_SUBMISSION_MESSAGE), dateAndTimeRegex);
  ...
  public void setup() {
    ...
    new LoginService()
        ...
        .clickLearningButton();
    new LearningService().navigateToTaskOfDepartmentAffiliateInUrgentTab(className, taskName);
  }
  ...
  public void checkPopUpHeader() {
    ...
    softAssert.assertTrue(tasksPopUpScreenOnLearningPageScreen
        ...
        .contains(globeIconPath), "Task icon is incorrect, globe icon isn't present!");
  ...
  public void checkPopUpTitle() {
    softAssert = new SoftAssert();
    softAssert.assertEquals(tasksPopUpScreenOnLearningPageScreen.getStatusLabelText(), taskStatus,
  ...
  public void checkStartDateAndDeadlineDate() {
    ...
    softAssert.assertTrue(datePattern.matcher(tasksPopUpScreenOnLearningPageScreen
            .getStartDateText())
        .find(), "'Start date' is incorrect!");
    ...
    softAssert.assertTrue(datePattern.matcher(tasksPopUpScreenOnLearningPageScreen
            .getStartDateText())
        .find(), "'Deadline date' is incorrect!");
    softAssert.assertAll();
  }
  ...
  public void checkAttempts() {
    assertTrue(Pattern.compile(attemptsRegex)
        ...
        .find(), "Attempts text is incorrect!");
  }
  ...
  public void checkUserInformation() {
    softAssert = new SoftAssert();
    softAssert.assertTrue(tasksPopUpScreenOnLearningPageScreen.isUserPhotoDisplayed(),
        "'User photo' isn't displayed!");
    softAssert.assertEquals(tasksPopUpScreenOnLearningPageScreen.getUserNameText(), studentName,
  ...
  public void checkStudentSubmittedAnswer() {
    ...
    softAssert.assertTrue(tasksPopUpScreenOnLearningPageScreen
        .clickShowMoreTextOfUserComment()
    ...
    softAssert.assertTrue(tasksPopUpScreenOnLearningPageScreen
            .clickShowLessTextOfUserComment()
  ...
  public void checkTaskChatDescriptionAndCommentField() {
    softAssert = new SoftAssert();
    softAssert.assertEquals(tasksPopUpScreenOnLearningPageScreen.getTaskChatDescriptionText(),
        getValueOf(ONLINE_POPUP_TASK_CHAT_LABEL), "'Task chat description' is incorrect!");
    softAssert.assertEquals(tasksPopUpScreenOnLearningPageScreen.getCommentFieldPlaceHolder(),
        getValueOf(ONLINE_POPUP_COMMENT_PLACEHOLDER), "Comment field 'placeholder' is incorrect!");
    softAssert.assertAll();
  }
  ...
  public void checkSubmitButton() {
    softAssert = new SoftAssert();
    softAssert.assertEquals(tasksPopUpScreenOnLearningPageScreen.getSubmitButtonText(),
        getValueOf(ONLINE_POPUP_SUBMIT_BUTTON), "Submit button text is incorrect!");
    softAssert.assertFalse(tasksPopUpScreenOnLearningPageScreen.isSubmitButtonEnabled(),
